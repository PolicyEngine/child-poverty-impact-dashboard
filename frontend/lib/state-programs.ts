    ...
    params: [
      {
        ...
        divide_by: 100,
        description:
          'Percentage of the federal EITC for filers with a child under 3. Current: 17% (raised from 12% by SB 1507 for tax year 2026).',
      },
      {
        ...
        divide_by: 100,
        description:
          'Percentage of the federal EITC for filers with no child under 3. Current: 14% (raised from 9% by SB 1507 for tax year 2026).',
      },
    ],
  },
  CT: {
...
const CTC_REFORMS: Record<string, CtcRegistryEntry> = {
  CA: {
    ...
    params: [
      ...
      ),
      {
        ...
        unit: '$',
        description:
          'Dollars of credit removed per earned-income increment (below) above the phase-out start. Current: $21.71 (2025).',
      },
      {
        name: 'phaseout_increment',
        label: 'Earned-income increment',
        path: 'gov.states.ca.tax.income.credits.young_child.phase_out.increment',
        default_value: 100,
        min_value: 1,
        max_value: 1000,
        step: 10,
        unit: '$',
        description: 'Earned-income step the reduction applies per. Current: $100.',
      },
    ],
  },
  DC: {
    ...
    params: [
      ...
      DOLLAR('threshold_surviving_spouse', 'Phase-out — surviving spouse', 'gov.states.dc.tax.income.credits.ctc.income_threshold.SURVIVING_SPOUSE', 55000, 'DC taxable income where phase-out begins (surviving spouse).'),
      {
        ...
        unit: '$',
        description:
          'Dollars of credit lost per income increment (below) of DC taxable income over the threshold. Current: $50 (2026).',
      },
      {
        name: 'phaseout_increment',
        label: 'Income increment (DC taxable income)',
        path: 'gov.states.dc.tax.income.credits.ctc.phase_out.increment',
        default_value: 1000,
        min_value: 1,
        max_value: 10000,
        step: 100,
        unit: '$',
        description: 'DC taxable income step the reduction applies per. Current: $1,000.',
      },
    ],
  },
  GA: {
  ...
  MD: {
    ...
    params: [
      ...
      DOLLAR('phaseout_threshold', 'Phase-out start (AGI)', 'gov.states.md.tax.income.credits.ctc.phase_out.threshold', 15000, 'Federal AGI where the credit starts phasing out.', 100000),
      {
        ...
        step: 5,
        unit: '$',
        description: 'Dollars of credit lost per AGI increment (below) over the threshold.',
      },
      {
        name: 'phaseout_increment',
        label: 'AGI increment',
        path: 'gov.states.md.tax.income.credits.ctc.phase_out.increment',
        default_value: 1000,
        min_value: 1,
        max_value: 10000,
        step: 100,
        unit: '$',
        description: 'AGI step the reduction applies per. Current: $1,000.',
      },
  ...
  ME: {
    ...
    params: [
      ...
      },
      {
        ...
        step: 5,
        unit: '$',
        description: 'Dollars of credit lost per AGI increment (below) above the threshold. Current: $20.',
      },
      {
        name: 'phaseout_increment',
        label: 'AGI increment',
        path: 'gov.states.me.tax.income.credits.dependent_exemption.phase_out.increment',
        default_value: 500,
        min_value: 1,
        max_value: 5000,
        step: 100,
        unit: '$',
        description: 'AGI step the reduction applies per. Current: $500.',
      },
    ],
  },
  MN: {
  ...
  VT: {
    ...
    params: [
      ...
      },
      {
        name: 'phaseout_increment',
        label: 'AGI increment',
        path: 'gov.states.vt.tax.income.credits.ctc.reduction.increment',
        default_value: 1000,
        min_value: 1,
        max_value: 10000,
        step: 100,
  ...
  NM: {
    ...
    params: [
      ...
      bracketAmt('gov.states.nm.tax.income.credits.ctc.amount', 2, 212, 'Tier 3 amount', 2000),
      bracketAmt('gov.states.nm.tax.income.credits.ctc.amount', 3, 106, 'Tier 4 amount', 2000),
      bracketAmt('gov.states.nm.tax.income.credits.ctc.amount', 4, 79, 'Tier 5 amount', 2000),
      bracketAmt('gov.states.nm.tax.income.credits.ctc.amount', 5, 53, 'Tier 6 amount', 2000),
      bracketAmt('gov.states.nm.tax.income.credits.ctc.amount', 6, 26, 'Tier 7 amount (highest AGI)', 2000),
